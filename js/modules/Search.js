          ...
          <div class="one-third">
            ...
            ${
              results.generalInfo.length
                ...
                : '<p>No general information that search.</p>'
            }
              ${results.generalInfo
                .map(
                  item =>
            ...
            ${
              results.campuses.length
                ...
                : `<p>No campuses match that search. <a href="${
                    universityData.root_url
                  }/campuses">View all programs</a></p>`
            }
              ${results.campuses
                .map(
                  item =>
      ...
      <div class="search-overlay">
        <div class="search-overlay__top">
          <div class="container">
              ...
              <input type="text" id="search-term" class="search-term" placeholder="What are your looking for?">
